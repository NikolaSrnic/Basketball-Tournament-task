...
Ovaj projekat zahteva NodeJS (ja sam koristio verziju 20) i NPM.
[Node](http://nodejs.org/) i [NPM](https://npmjs.org/) su veoma jednostavni za instalaciju.
Da biste proverili da li su dostupni na vašem računaru, pokušajte da pokrenete sledeću komandu:
